=== WP Purchase Notification ===
Contributors: carlosramosweb
Donate link: http://donate.criacaocriativa.com
Tags: woocommerce, purchase, notification, alert, audible warning, delivery.
...
Plugin that notifies new purchase on WooCommerce by playing an audio alert.
Plugin que notifica nova compra no WooCommerce tocando um audio de alerta.
...
3. Vá no menu [WooCommerce > Configurações > Pagamentos] na opção 'WP Notificações' e clique em Habilitado.
